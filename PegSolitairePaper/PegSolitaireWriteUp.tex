...
% Figures
% Figure 1: Figure1.eps, Sample $F_7$ board and standard indexing notation
% Figure 2: Figure2..eps, Sample $E_7$ and $T_5$ boards
% Figure 3: Figure3.eps, $F_7$ board expressed in Java code
...
\title{Peg Solitaire: A Study on Which Boards are the Most Favorable to Solve}
